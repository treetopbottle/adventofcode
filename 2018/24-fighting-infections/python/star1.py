...
class Group():
    ...
    def attack(self):
        ...
        nr_units_damage = damage // self.target.hit_points
        nr_units_killed = min(nr_units_damage, self.target.nr_units)
...
if __name__ == '__main__':
    ...
    if infection.contains_units():
        print(infection.total_units)
